...
@section('content')
    ...
    <div class="container-fluid py-4 px-lg-5">
        ...
        <div class="mb-4 d-flex align-items-center">
            ...
            <div class="ms-auto">
                <a href="{{ route('invite.index') }}" class="btn btn-primary">
        ...
        <div class="card shadow-sm p-0">
            ...
            @if ($clients->count() > 0)
                        ...
                        <tbody>
                            @foreach ($clients as $client)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        {{ number_format($client->shortUrls()->sum('total_hits')) }}
                ...
                <div class="card-footer d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('super_admin.clientdashboard') }}" class="footer-link">
                        View All Clients →
                    </a>
                </div>
            @else
        ...
        <div class="card shadow-sm p-0">
            ...
            @if ($urls->count() > 0)
                    ...
                    <table class="table table-hover">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-start">
                                    <i class="bi bi-globe me-2"></i>Long URL
                                </th>
                                ...
                                <th class="text-center">
                                    <i class="bi bi-calendar3 me-2"></i>Created On
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="card-footer d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('super_admin.urlDashboard') }}" class="footer-link">
                        View All Clients →
                    </a>
                </div>
            @else
